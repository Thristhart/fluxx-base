...
Fluxx::Card.create(type: :rule, name: 'Draw 4', description: 'Draw 4 cards', modifier: :draw_limit, new: 4)
Fluxx::Card.create(type: :rule, name: 'Draw 2', description: 'Draw 2 cards', modifier: :draw_limit, new: 2)
